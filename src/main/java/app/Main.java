...
//            AudioManager audioManager = new AudioManager("/power.wav");
            ...
            LoginView loginView = LoginUseCaseFactory.create(viewManagerModel, loginViewModel, translationViewModel, signupViewModel, userDataAccessObject, audioController, historyViewModel); // Pass audioController
